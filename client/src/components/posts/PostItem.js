          ...
          <div className="col-md-10">
            ...
            {showActions ? (
              <span>
                ...
                {post.user === auth.user.id ? <button onClick={this.onDeleteClick.bind(this, post._id)} className="btn btn-danger mr-1" type="button"><i className="fas fa-times" /></button> : null}
              </span>
            ) : null}
          </div>
        </div>
