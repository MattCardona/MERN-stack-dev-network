    ...
    return (
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          {expItems.length > 0 ? <ul className="list-group">{expItems}</ul> : <p>No Experience Listed.</p>}

        </div>

        <div className="col-md-6">
          <h3 className="text-center text-info">Education</h3>
          {eduItems.length > 0 ? <ul className="list-group">{eduItems}</ul> : <p>No Education Listed.</p>}
        </div>
